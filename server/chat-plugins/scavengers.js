...
exports.commands = {
	...
	scavengershelp(target, room, user) {
		...
		const staffCommands = [
			...
			"- /start(official/practice/mini/unrated)hunt <em>[twist] | [host] | [hint] | [answer] | [hint] | [answer] | [hint] | [answer] | ...</em> - creates a new scavenger hunt, giving points if assigned.  Blitz and wins will count towards the leaderboard. (Requires: % @ * # & ~)",
			...
			"- /starttwist(hunt/practice/official/mini/unrated) <em>[host] | [hint] | [answer] | [hint] | [answer] | [hint] | [answer] | ...</em>  - creates a new regular scavenger hunt that uses a twist mode in the specified game type.  This can be used inside a scavenger game mode.",
